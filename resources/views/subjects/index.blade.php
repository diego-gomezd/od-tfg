                            ...
                            <div class="bg-white overflow-hidden border-b border-gray-200 sm:rounded-lg grid grid-cols-3 gap-4">
                                <div class="px-6 py-3 text-left text-md">
                                    <div class="mt-1 flex rounded-md shadow-sm">
                                        <x-input id="filter_name" type="text" name="filter_name" placeholder="Nombre o código de asignatura" :value="$filter_subject_name" />
                                    </div>
                                </div>
                                <div class="px-6 py-3 text-left text-md">
                                    <div class="mt-1 flex rounded-md shadow-sm">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if ($subject->department_id != null)
                                <div class="text-sm font-medium text-gray-900">{{Str::limit($subject->department->name, 50)}}</div>
                                <div class="text-sm font-medium text-gray-500">Código: {{$subject->department->code}}</div>
                                @endif
                                </th>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{$subject->ects}}</div>
                                </th>
                            <td class="px-6 py-4 whitespace-nowrap">
