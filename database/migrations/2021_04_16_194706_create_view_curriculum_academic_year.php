...
class CreateViewCurriculumAcademicYear extends Migration
{
    ...
    {
        DB::statement(
            'CREATE VIEW curriculum_academic_year AS SELECT ac.id AS academic_year_id, ac.name AS academic_year_name, c.id AS curriculum_id, c.code AS curriculum_code, c.name AS curriculum_name, COUNT(cs.id) AS number_subjects '
